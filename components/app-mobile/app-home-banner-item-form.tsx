...
import {
  createAppMobileHomeBannerItemAction,
  updateAppMobileHomeBannerItemAction,
...
export function AppHomeBannerItemForm(props: Props) {
  const router = useRouter();
  const action = props.mode === "create" ? createAppMobileHomeBannerItemAction : updateAppMobileHomeBannerItemAction;
    ...
    <form action={formAction} className="mt-2 flex flex-col gap-4">
      ...
      <div>
        ...
        <div className="mt-3">
          ...
          {!hasIcon ? (
            <p className="mt-2 text-xs font-medium text-red-700">Vui lòng chọn icon SVG trước khi lưu.</p>
          ) : null}
        </div>
      </div>
